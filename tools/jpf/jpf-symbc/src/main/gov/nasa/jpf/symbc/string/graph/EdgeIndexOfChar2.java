...
public class EdgeIndexOfChar2 implements Edge {
	Vertex source, dest;
	SymbolicIndexOfChar2Integer sioi;
	String name;
	
	public EdgeIndexOfChar2 (String name, Vertex source, Vertex dest, SymbolicIndexOfChar2Integer sioi) {
		this.name = name;
		this.source = source;
		this.dest = dest;
		this.sioi = sioi;
	...
	public SymbolicIndexOfChar2Integer getIndex () {
		return sioi;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EdgeIndexOfChar2 other = (EdgeIndexOfChar2) obj;
		if (dest == null) {
			if (other.dest != null)
				return false;
	...
	public Edge cloneAndSwapVertices(Map<Vertex, Vertex> oldToNew) {
		return new EdgeIndexOfChar2(name, oldToNew.get(source),
