...
public class EdgeStartsWith implements Edge{
	Vertex v1, v2;
	final String name;
	
	public EdgeStartsWith (String name, Vertex v1, Vertex v2) {
		this.v1 = v1;
		this.v2 = v2;
		this.name = name;
	}
	...
	public boolean equals(Object obj) {
		if (!(obj instanceof EdgeStartsWith)) {
			return false;
		}
		if (this == obj)
			return true;
		...
		if (getClass() != obj.getClass())
			return false;
		EdgeStartsWith other = (EdgeStartsWith) obj;
		if (v1 == null) {
			if (other.v1 != null)
				return false;
		} 
	...
	public Edge cloneAndSwapVertices(Map<Vertex, Vertex> oldToNew) {
		return new EdgeStartsWith(name, oldToNew.get(v1), oldToNew.get(v2));
	}
}
