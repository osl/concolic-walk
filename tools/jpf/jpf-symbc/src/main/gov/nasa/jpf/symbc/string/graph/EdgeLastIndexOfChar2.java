...
public class EdgeLastIndexOfChar2 implements Edge {
	Vertex source, dest;
	SymbolicLastIndexOfChar2Integer sioi;
	String name;
	
	public EdgeLastIndexOfChar2 (String name, Vertex source, Vertex dest, SymbolicLastIndexOfChar2Integer sioi) {
		this.name = name;
		this.source = source;
		this.dest = dest;
		this.sioi = sioi;
	...
	public SymbolicLastIndexOfChar2Integer getIndex () {
		return sioi;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EdgeLastIndexOfChar2 other = (EdgeLastIndexOfChar2) obj;
		if (dest == null) {
			if (other.dest != null)
				return false;
	...
	public Edge cloneAndSwapVertices(Map<Vertex, Vertex> oldToNew) {
		return new EdgeLastIndexOfChar2(name, oldToNew.get(source), oldToNew.get(dest), sioi);
	}
}
